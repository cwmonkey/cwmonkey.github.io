...
(function() {
	...
	postLinkEls.forEach((el) => {
		...
		if (!matches) return;
		const src = 'https://platform.twitter.com/embed/Tweet.html?dnt=true&embedId=twitter-widget-' + twitterId + '&id=' + matches[2] + '&' + twitterParams;
