...
(function() {
    ...
    const scriptDataEl = window.parent.window.document.querySelector('script.player-microformat-renderer, script.ytd-player-microformat-renderer, #microformat script');
