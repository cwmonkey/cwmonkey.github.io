...
var $main=$('#main');var $title=$('title');var $div=$('<div/>');var path;var has_transitionend=('ontransitionend'in window);$.fn.addClassWait=function(name){var $el=this;var deferred=new $.Deferred();if(!has_transitionend){this.addClass(name);deferred.resolve();return deferred;}
